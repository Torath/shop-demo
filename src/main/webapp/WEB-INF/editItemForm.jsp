...
<div class="container">
    <form:form method="POST" modelAttribute="editItemForm" class="form-signin">
        <h2 class="form-signin-heading">Edytuj produkt ${editItemForm.nazwaProduktu}</h2>
        Nazwa produktu:
        ...
        <br/>
        <button class="btn btn-lg btn-primary btn-block" type="submit">Dodaj</button><a href="welcome">Anuluj</a>
    </form:form>
</div>
